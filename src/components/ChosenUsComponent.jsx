...
// Recuerda importar tus íconos correctamente. Ejemplo si usas react-icons:
...
const ChosenUsComponent = () => {
  // Duplicamos exactamente x2 para lograr la simetría perfecta en el bucle infinito
    ...
    <>
      ...
      <section className="relative z-10 w-full bg-white text-gray-900 py-20 px-4 md:px-8 overflow-hidden">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Columna Derecha: Mensajes, Botón y Redes */}
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left w-full overflow-hidden order-1 lg:order-2">
            ...
            >
              Llegó el momento de superarlos.<br /> Sumate a la élite de marcas que ya están un paso adelante.
            </motion.h3>
            ...
            {/* Contenedor del Botón e Íconos */}
            <div className="flex flex-col sm:flex-row items-center gap-6 mt-2 w-full sm:w-auto">
              <button className="bg-ps-blue text-ps-white font-bold px-8 py-3 rounded-full hover:bg-ps-mblue transition-colors shadow-md w-full sm:w-auto"> 
                ¡Sumate a nuestro proyecto! 
              </button>

              <div className="flex items-center gap-5 text-gray-700 hover:text-gray-900">
                <a 
                  target="_blank" 
                  ...
                  href="https://wa.me"
                >
                  <AiOutlineWhatsApp className="w-18 h-18 md:w-14 md:h-14" />
                </a> 
                ...
                >
                  <FaInstagram className="w-18 h-18 md:w-14 md:h-14" />
                </a> 
                ...
                >
                  <AiOutlineMail className="w-18 h-18 md:w-14 md:h-14" />
                </a>
              </div>
            </div>
          </div>
